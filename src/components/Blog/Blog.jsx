          ...
          <Card key={blog._id} className={`${styles.blogCard}`}>
            ...
            <Card.Footer className={styles.cardFooter}>
              <Link to={`/blogpost/${blogID}`}>
                <button className={styles.readBtn}>Read Me</button>
              </Link>
              <small className={`text-muted ${styles.date}`}>{date}</small>
            </Card.Footer>
          </Card>
        </div>
      );
          ...
          <div className={styles.gridHeading}>
            ...
            <div className="gridDescription">
              <p className="whiteDescription">
                Learn more about the new technologies I’m learning through my
                blog posts!
              </p>
            </div>
          </div>

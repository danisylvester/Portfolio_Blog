  ...
  return (
    <div>
      <div id="home" className={styles.grid}>
          ...
          <div className={styles.textWrapper}>
            <div>
              <div className={styles.textRowOne}>
                <p>
                  I'm <span className={styles.dani}>Dani</span>, I create
                </p>
              </div>
              <div className={styles.textRowTwo}>
                <h2 className={styles.rowTwoHeading}>
                  user-centric web applications
                </h2>
              </div>
              <div className={styles.textRowThree}>
                <p>
                  I'm a software developer with a passion for creative problem
        ...
        <div
          className={styles.gridComputerBkg}
